...
//         this.client.login(process.env.DISCORD_API_TOKEN).catch(console.error);
...
//     async sendLogToDiscord(message: string) {
...
//             groupTitle: ` ${this.logsTitle}`,
//         });
//         await this.sendLogToDiscord(strings.join(" "));
//     }

//     async warn(...strings: any[]) {
//         this.#logWithStyle(strings, {
//             fg: "yellow",
//             bg: "",
//             icon: "\u26a0",
...
//             console.log(message);
//         }
//         await this.sendLogToDiscord(message);
//     }
// }
