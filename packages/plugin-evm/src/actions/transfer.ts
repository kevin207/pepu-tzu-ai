...
export const transferAction = {
    name: "transfer",
    description:
        "Transfer tokens between addresses on the same chain. Cannot transfer native token such as ETH.",
    handler: async (
        runtime: IAgentRuntime,
        _message: Memory,
        state: State,
        ...
        const action = new TransferAction(walletProvider, runtime);
